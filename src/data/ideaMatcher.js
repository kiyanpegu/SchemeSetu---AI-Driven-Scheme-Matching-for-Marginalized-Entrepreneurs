...
export function evaluateBusinessIdea(text = "", lang = "en") {
  ...
  const hasFemaleKeywords =
    /\b(woman|female|girl|women|mother|sister|wife|daughter|lady|madam|ms|mrs)\b/i.test(
      lower,
    ) ||
    text.includes("महिला") ||
  ...
  const isLivestock =
    /\b(pig|piggery|pigs|pork|poultry|chicken|broiler|layer|dairy|cow|cows|buffalo|cattle|livestock|goat|goats|bakri|goatry|fish|fishery|fishpond|aquaculture|farm|farming|husbandry)\b/i.test(
      lower,
    ) ||
    text.includes("सूअर") ||
    text.includes("सुअर") ||
    text.includes("मुर्गी") ||
    text.includes("डेयरी") ||
    text.includes("पशु") ||
    text.includes("मछली") ||
    text.includes("बकरी") ||
    text.includes("पालन") ||
    text.includes("पोल्ट्री") ||
    text.includes("গাহৰি") ||
    text.includes("কুকুৰা") ||
    text.includes("গাখীৰ") ||
    text.includes("মাছ") ||
    text.includes("পাম") ||
    text.includes("পশুপালন");

  // B. Traditional Artisans & Craftspeople (PM Vishwakarma)
  const isArtisan =
    /\b(blacksmith|carpenter|potter|cobbler|barber|mason|sculptor|toolmaker|weaver|handloom|goldsmith|locksmith|boat|vishwakarma)\b/i.test(
      lower,
    ) ||
    text.includes("लोहार") ||
    text.includes("बढ़ई") ||
  ...
  const isStreetVendor =
    /\b(street|vendor|vending|chai|tea stall|hawker|cart|fruit stall|vegetable stall|fast food|snack stall|pan shop)\b/i.test(
      lower,
    ) ||
    text.includes("ठेला") ||
    text.includes("फेरीवाला") ||
    text.includes("चाय की दुकान") ||
    text.includes("रेहड़ी") ||
    text.includes("পদপথৰ বিক্ৰেতা") ||
    text.includes("চাহৰ দোকান") ||
    text.includes("ঠেলা");

  // D. Green Business, E-Rickshaw, Solar, EV
  const isGreenBusiness =
    /\b(e-rickshaw|erickshaw|rickshaw|toto|solar|rooftop|clean energy|ev|battery|waste|vermicompost|bio-gas|biogas|polyhouse)\b/i.test(
      lower,
    ) ||
    text.includes("ई-रिक्शा") ||
    text.includes("सौर") ||
    text.includes("बायोगैस") ||
    text.includes("ৰিক্সা") ||
    text.includes("সৌৰ শক্তি") ||
    text.includes("সেউজ");

  // E. Sanitation, Sewer Cleaning, Mechanization (NSKFDC SUY)
  const isSanitation =
    /\b(sanitation|sewer|septic|cleaning|safai|scavenger|suction machine|jetting|waste transport|garbage)\b/i.test(
      lower,
    ) ||
    text.includes("सफाई") ||
    text.includes("सीवर") ||
    ...
    text.includes("চাফাই") ||
    text.includes("নলা পৰিষ্কাৰ");

  // F. Higher Education, Professional Degree (NSFDC ELS)
  const isEducation =
    /\b(study|college|degree|btech|mtech|mbbs|tuition|fee|fees|engineering|medical|university|course)\b/i.test(
      lower,
    ) ||
    text.includes("शिक्षा") ||
    text.includes("कॉलेज") ||
    text.includes("फीस") ||
    text.includes("ডিগ্ৰী") ||
    text.includes("পঢ়া-শুনা") ||
    text.includes("মহাবিদ্যালয়");

  // G. Small Retail, Grocery, Mobile Repair, Kirana (NSFDC LVY / Suvidha)
  const isRetailRepair =
    /\b(mobile repair|electronics|repair|kirana|grocery|small shop|hardware|retail store|stationery)\b/i.test(
      lower,
    ) ||
    text.includes("किराना") ||
    text.includes("मोबाइल रिपेयर") ||
    text.includes("दुकान") ||
    text.includes("দোকান") ||
    text.includes("মেৰামতি");

  // H. Boutique, Tailoring, Sewing, Parlour
  const isTailoringOrBeauty =
    /\b(tailor|tailoring|sewing|boutique|garments|cloth|beauty parlour|salon|dressmaking)\b/i.test(
      lower,
    ) ||
    text.includes("सिलाई") ||
    text.includes("बुटीक") ||
    text.includes("पार्लर") ||
    text.includes("চিলাই") ||
    text.includes("বুটিংক") ||
    text.includes("কাপোৰ");
  ...
  let whyFits;
  let riskAssessment =
    "Eligible for concessional public-sector credit assistance under priority lending sector.";
  let actionPlan;
  ...
  if (isLivestock) {
    ...
    sector =
      lang === "hi"
        ? "पशुपालन एवं कृषि-संबद्ध उद्यम (सूअर पालन / डेयरी इकाई)"
        : lang === "as"
          ? "পশুপালন আৰু কৃষি-আনুষঙ্গিক উদ্যোগ (গাহৰি পাম / দুগ্ধ ফাৰ্ম)"
    ...
    sector =
      lang === "hi"
        ? "पारंपरिक शिल्प एवं दस्तकारी"
        : lang === "as"
          ? "পাৰম্পৰিক হস্তশিল্প আৰু কাৰিকৰী"
    ...
    sector =
      lang === "hi"
        ? "हरित ऊर्जा एवं स्वच्छ परिवहन (ई-रिक्शा / सौर इकाई)"
        : lang === "as"
          ? "সেউজ শক্তি আৰু পৰিবহণ (ই-ৰিক্সা / সৌৰ প্ৰকল্প)"
          : "Green Energy & Clean Mobility (E-Rickshaw / Solar)";
    ...
    sector =
      lang === "hi"
        ? "स्ट्रीट वेंडिंग एवं लघु खान-पान सेवा"
        : lang === "as"
          ? "পথৰ ক্ষুদ্ৰ ব্যৱসায় আৰু খাদ্য সেৱা"
          : "Street Vending & Food Kiosk";
    ...
    sector =
      lang === "hi"
        ? "स्वच्छता एवं मशीनीकृत सीवर सफाई"
        : lang === "as"
          ? "স্বচ্ছতা আৰু মেচিনযুক্ত নলা পৰিষ্কাৰ"
    ...
    sector =
      lang === "hi"
        ? "व्यावसायिक एवं तकनीकी उच्च शिक्षा"
        : lang === "as"
          ? "উচ্চ কাৰিকৰী আৰু পেছাদাৰী শিক্ষা"
    ...
    sector =
      lang === "hi"
        ? "महिला स्वरोजगार (सिलाई व बुटीक)"
        : lang === "as"
          ? "মহিলা আত্মনিয়োজন (চিলাই আৰু বুটিংক)"
          : "Women Micro-Enterprise (Tailoring & Boutique)";
    ...
    sector =
      lang === "hi"
        ? "लघु व्यापार एवं वाणिज्यिक सेवा"
        : lang === "as"
          ? "ক্ষুদ্ৰ ব্যৱসায় আৰু বাণিজ্যিক সেৱা"
          : "Small Retail & Commercial Services";
    ...
    sector =
      lang === "hi"
        ? "सूक्ष्म उद्यम एवं स्वरोजगार"
        : lang === "as"
          ? "ক্ষুদ্ৰ উদ্যোগ আৰু আত্মনিয়োজন"
  ...
  if (
    ...
    sector =
      lang === "hi"
        ? "लघु व्यवसाय एवं वाणिज्यिक उद्यम"
        : lang === "as"
          ? "ক্ষুদ্ৰ ব্যৱসায় আৰু বাণিজ্যিক উদ্যোগ"
          : "Small Enterprise & Commercial Trade";
  }
