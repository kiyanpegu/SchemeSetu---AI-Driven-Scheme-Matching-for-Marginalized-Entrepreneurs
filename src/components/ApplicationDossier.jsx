...
export default function ApplicationDossier({
  ...
  const schemeCode =
    scheme.id
      ...
      .toUpperCase()
      .slice(0, 5) || "NSFDC";
  const numericSeed = scheme.id
    .split("")
    .reduce((acc, c) => acc + c.charCodeAt(0), 48201);
  const refCode = `SETU-SC-2026-${schemeCode}-${(numericSeed % 89999) + 10000}`;

  const currentDate = new Date().toLocaleDateString(
    lang === "hi" ? "hi-IN" : lang === "as" ? "as-IN" : "en-IN",
    {
      day: "2-digit",
      month: "short",
      year: "numeric",
  ...
  const dossierTexts = {
    en: {
      ...
      disclaimer:
        "SchemeSetu is an AI-powered scheme discovery platform designed under SIH Problem Statement 26092 (Ministry of Social Justice and Empowerment). Final sanction is subject to physical verification of caste credentials and bank underwriting guidelines.",
    },
    hi: {
      barTitle: "आधिकारिक आवेदन तैयारी डॉसियर",
      barSub:
        "योजना के त्वरित प्रसंस्करण के लिए यह दस्तावेज़ बैंक शाखा में ले जाएं",
      printBtn: "प्रिंट / पीडीएफ सेव करें",
      channelTag: "MoSJE / NSFDC रियायती वित्तपोषण चैनल",
      dossierTitle: "SchemeSetu लाभार्थी डॉसियर",
      dossierSub:
        "राष्ट्रीय अनुसूचित जाति वित्त एवं विकास निगम (NSFDC) सहायता पर्ची",
      dateLabel: "दिनांक:",
      ...
      checklistTitle:
        "बैंक में जमा किए जाने वाले अनिवार्य दस्तावेजों की चेकलिस्ट",
      checklistDesc:
        "कृपया नोडल बैंक अधिकारी के पास अपना आवेदन जमा करने से पहले निम्नलिखित सत्यापित प्रमाणपत्रों की भौतिक प्रतियों पर टिक करें और संलग्न करें:",
      sigApplicant: "आवेदक के हस्ताक्षर / अंगूठे का निशान",
      sigOfficer: "अधिकृत बैंक नोडल अधिकारी / SCA की मुहर एवं हस्ताक्षर",
      disclaimer:
        "SchemeSetu सामाजिक न्याय एवं अधिकारिता मंत्रालय (MoSJE) के तहत SIH समस्या विवरण 26092 हेतु विकसित एक AI-संचालित मंच है। अंतिम ऋण स्वीकृति जाति प्रमाण पत्र के भौतिक सत्यापन एवं बैंक के नियमों के अधीन है।",
    },
    as: {
      barTitle: "আনুষ্ঠানিক আবেদন প্ৰস্তুতি ডচিয়েৰ",
      barSub:
        "আঁচনিৰ অগ্ৰাধিকাৰমূলক প্ৰক্ৰিয়াকৰণৰ বাবে এই নথি বেংক শাখালৈ লৈ যাওক",
      printBtn: "প্ৰিণ্ট / PDF সংৰক্ষণ কৰক",
      channelTag: "MoSJE / NSFDC ৰেহাই বিত্তীয় চেনেল",
      dossierTitle: "SchemeSetu হিতাধিকাৰী ডচিয়েৰ",
      dossierSub:
        "ৰাষ্ট্ৰীয় অনুসূচীত জাতি বিত্ত আৰু উন্নয়ন নিগম (NSFDC) সাহায্য শ্লিপ",
      dateLabel: "তাৰিখ:",
      ...
      partnerTypesVal:
        "ৰাজহুৱা খণ্ডৰ বেংক (PSBs), আঞ্চলিক গ্ৰাম্য বেংক, ৰাজ্যিক এছচিএ",
      ...
      checklistTitle:
        "বেংকত জমা দিবলগীয়া বাধ্যতামূলক নথি-পত্ৰৰ পৰীক্ষা-তালিকা",
      checklistDesc:
        "অনুগ্ৰহ কৰি ন’ডেল বেংক বিষয়াৰ ওচৰত আবেদন জমা দিয়াৰ পূৰ্বে তলত দিয়া প্ৰমাণিত নথি-পত্ৰসমূহ চিহ্নিত কৰি সংলগ্ন কৰক:",
      sigApplicant: "আবেদনকাৰীৰ স্বাক্ষৰ / বুঢ়া আঙুলিৰ চাপ",
      sigOfficer: "কৰ্তৃত্বপ্ৰাপ্ত বেংক বিষয়া / SCA ৰ ছীল আৰু স্বাক্ষৰ",
      disclaimer:
        "SchemeSetu হৈছে সামাজিক ন্যায় আৰু সৱলীকৰণ মন্ত্ৰালয়ৰ অধীনত SIH সমস্যা বিবৃতি ২৬০৯২ ৰ বাবে নিৰ্মিত এক AI-চালিত প্লেটফৰ্ম। চূড়ান্ত অনুমোদন জাতিগত প্ৰমাণপত্ৰৰ শাৰীৰিক পৰীক্ষণ আৰু বেংকৰ নীতি-নিয়মৰ ওপৰত নিৰ্ভৰশীল।",
    },
  };
  ...
  const checklistItems = [
    {
      ...
      label:
        lang === "hi"
          ? "सक्षम प्राधिकारी (तहसीलदार / एसडीएम) द्वारा जारी वैध अनुसूचित जाति (SC) प्रमाण पत्र"
          : lang === "as"
            ? "প্ৰশাসনৰ দ্বাৰা প্ৰদান কৰা বৈধ অনুসূচীত জাতি (SC) প্ৰমাণপত্ৰ"
            : "Valid Scheduled Caste (SC) Certificate issued by competent revenue authority (SDM/Tehsildar)",
    },
    {
      id: 2,
      label:
        lang === "hi"
          ? "पारिवारिक वार्षिक आय प्रमाण पत्र (₹3.00 लाख से कम)"
          : lang === "as"
            ? "বাৰ্ষিক পাৰিবাৰিক আয় প্ৰমাণপত্ৰ (৩ লাখ টকাৰ তলত)"
            : "Family Annual Income Certificate / Self-Declaration (strictly under ₹3.00 Lakh)",
    },
    {
      id: 3,
      label:
        lang === "hi"
          ? "आधार कार्ड एवं पैन कार्ड (पहचान व निवास प्रमाण)"
          : lang === "as"
            ? "আধাৰ কাৰ্ড আৰু পেন কাৰ্ড"
            : "Aadhaar Card and PAN Card (Identity & Residence verification)",
    },
    {
      id: 4,
      label:
        lang === "hi"
          ? "व्यापार परियोजना रिपोर्ट / मशीनरी या उपकरणों का अनुमानित कोटेशन"
          : lang === "as"
            ? "ব্যৱসায়ৰ প্ৰকল্প প্ৰতিবেদন বা কোটেশ্বন"
            : "Business Project Report / Machinery & Equipment Cost Quotation (or College Admission Letter)",
    },
    {
      id: 5,
      label:
        lang === "hi"
          ? "आधार से जुड़ा सक्रिय बैंक खाता पासबुक (पिछले 6 माह का विवरण)"
          : lang === "as"
            ? "আধাৰ সংযুক্ত বেংক পাছবুক (বিগত ৬ মাহৰ তথ্য)"
            : "Aadhaar-seeded Active Bank Account Passbook (Statement of last 6 months)",
    },
    {
      id: 6,
      label:
        lang === "hi"
          ? "पासपोर्ट साइज रंगीन फोटोग्राफ (3 प्रतियां)"
          : lang === "as"
            ? "পাছপ’ৰ্ট আকাৰৰ ৩ কপি ফটো"
    ...
    },
    {
      ...
      label:
        lang === "hi"
          ...
          : lang === "as"
            ? "বয়সৰ প্ৰমাণপত্ৰ"
            : "Age Proof Document (10th Marksheet, Voter ID, or Birth Certificate)",
    },
  ];
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 print:p-0 print:bg-white print:fixed print:inset-0"
    >
      {/* Container */}
      <div className="bg-surface text-on-surface w-full max-w-3xl rounded-2xl shadow-2xl border border-surface-container overflow-hidden print:border-none print:shadow-none print:rounded-none print:max-w-none print:w-full">
        ...
        <div className="bg-primary px-6 py-4 text-on-primary flex justify-between items-center print:hidden">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-primary-container-light">
                {dt.barSub}
              </p>
            </div>
          </div>
        ...
        <div
          ref={dossierRef}
          className="p-6 sm:p-8 bg-white text-slate-900 print:p-6 print:text-black"
        >
          {/* Header */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-left border-t border-slate-200 pt-3">
              <div>
                ...
                <span className="text-sm font-bold text-slate-900">
                  {scheme.maxAmount ||
                    `₹${scheme.loan_amount_max?.toLocaleString("en-IN")}`}
                </span>
              </div>
              <div>
                <span className="text-[10px] uppercase font-semibold text-slate-500 block">
                ...
                <span className="text-sm font-bold text-blue-900">
                  {scheme.interest || `${scheme.interest_rate_min}% p.a.`}
                </span>
              </div>
              <div>
                <span className="text-[10px] uppercase font-semibold text-slate-500 block">
                ...
                <span className="text-sm font-bold text-slate-900">
                  {scheme.moratorium_period
                    ? `${scheme.moratorium_period} Months Moratorium`
                    : "3-6 Months"}
                </span>
              </div>
              <div>
                ...
                <span className="text-sm font-bold text-slate-900">
                  {scheme.repayment_period
                    ? `${scheme.repayment_period / 12} Years (${scheme.repayment_period} mo)`
                    : "Up to 5 Years"}
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="border border-slate-200 rounded-lg p-3 bg-white">
              ...
              <ul className="text-xs space-y-1.5 text-slate-700">
                <li>
                  <strong>{dt.catLabel}</strong> {dt.catVal}
                </li>
                <li>
                  <strong>{dt.purposeLabel}</strong>{" "}
                  {userData?.purpose === "edu" ? dt.purposeEdu : dt.purposeBiz}
                </li>
                <li>
                  <strong>{dt.incomeLabel}</strong>{" "}
                  {userData?.income
                    ? `₹${Number(userData.income).toLocaleString("en-IN")}`
                    : dt.incomeCap}
                </li>
                <li>
                  <strong>{dt.ageLabel}</strong>{" "}
                  {userData?.age ? `${userData.age} Years` : dt.ageVal}
                </li>
              </ul>
            </div>
            ...
            <div className="border border-slate-200 rounded-lg p-3 bg-white">
              ...
              <ul className="text-xs space-y-1.5 text-slate-700">
                <li>
                  <strong>{dt.channelAgency}</strong>{" "}
                  {scheme.implementing_agency ||
                    "State Channelizing Agency (SCA) & Public Sector Banks"}
                </li>
                <li>
                  <strong>{dt.partnerTypes}</strong> {dt.partnerTypesVal}
                </li>
                <li>
                  <strong>{dt.appMode}</strong>{" "}
                  {scheme.online_application_available
                    ? dt.appModeOnline
                    : dt.appModeOffline}
                </li>
                <li>
                  <strong>{dt.portalLabel}</strong>{" "}
                  <span className="text-[10px] text-blue-800 break-all">
                    {scheme.official_application_portal || scheme.source_url}
                  </span>
                </li>
              </ul>
            </div>
